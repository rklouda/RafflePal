		...
		<div class="container">
			<ul id="nav" class="sixteen columns">
			  ...
			  <a class="drp-aro" href="/About.php" >About  </a>
						...
						<li class="">
			  <a class="drp-aro" href="/team.php" >Team </a>
			            </li> 
...
<div class="clearfix"></div>
    ...
    <h1 class="landing_headline">Aid Request Application</h1>
        ...
        <div class="col-sm-6 col-xs-12 text-center">
            <div class="entry-box panel panel-default">
             ...
             <br/>
                  ...
                  <form id="new-app-form" class="form-horizontal" role="form" action="/aidRequestAppForm.1.php" method="POST">
                            <div class="bottom text-center">
...
<p><strong>Email: </strong> <a href="raklouda@aol.com"> Contact@Helpnow.com </a> </p>
