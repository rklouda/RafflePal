<?php
 ...
 if ( isset($_POST['btn-signup']) ) {
  ...
  if( !$error ) {
   ...
   $query = "INSERT INTO AGENT(First_Name,Agent_Email,Password) VALUES('$name','$email','$password')";
...
<div class="row">
 ...
 <div id="login-form">
   ...
   ?>
            ...
            <div class="form-group">
             <button type="submit" class="btn btn-lg btn-inf" name="btn-login">Sign In</button>
            </div>
