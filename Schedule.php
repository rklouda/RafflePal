...
//NO LOGIN REQUIRED TO ADD TO THIS DATABASE
 ...
 if ( isset($_POST['btn-save-appointment']) ) {
...
// $query= "INSERT INTO `Agent`.`APPOINTMENTS` (`Date`, `Time`, `Name`, `Email`, `Appt_ID`, `Phone_Number`) VALUES (\'2017-04-14\', \'1:00:pm\', \'Rob\', \'r@gmail.com\', NULL, \'2333333\');";
//$query = "INSERT INTO APPOINTMENTS(Name, Email, Phone_Number, Date, Time) VALUES(\'$Name\', \'$Email\', \'$Phone_Number\',\'$Date\',\'$Time\')";

$query = "INSERT INTO APPOINTMENTS(Name, Email, Phone_Number, Date, Time) VALUES('$Name', '$Email', '$Phone_Number','$Date','$Time')";
   $res = mysqli_query($db,$query);

 echo "<script type='text/javascript'>alert('Your appointment has been scheduled. An agent will contact you.')</script>";
   header("Refresh:0");
...
<div class="clearfix"></div>
       ...
       <h1 class="landing_headline">Schedule an Appointment</h1>
...
<div class="row">
	...
	<h4><strong>Schedule an Appoinment.</strong></h4>
	<p>Choose Date Below:</p>
...
<script src="https://ajax.googleapis.com/ajax/libs/jqueryui/1.11.4/jquery-ui.min.js"></script>
  ...
  EASIER WAY TO DO THIS add type = date to the input statement as part of bootstrap vs. jqueiry
-->
...
<body>
    ...
    <form  method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" autocomplete="off">
      ...
      <div class="form-group">
             ...
             <input type="date" style="font-size: 14pt" name="Date" class="form-control" required="true" maxlength="40" value="<?php echo $Date ?>" />
                </div>
      </div>
            <div class="form-group">
             <div class="input-group">
                <span class="input-group-addon"><span class="glyphicon glyphicon-time"></span></span>
             <input type="time" style="font-size: 14pt" name="Time" class="form-control" required="true" maxlength="40" value="<?php echo $Time ?>" />
                </div>
      </div> 
        ...
        <div class="form-group">
             ...
             <input type="text" style="font-size: 14pt" name="Name" class="form-control" required="true" placeholder="Enter your Name" maxlength="40" value="<?php echo $Name ?>" />
                </div>
        </div>
        ...
        <div class="form-group">
             ...
             <input type="text" style="font-size: 14pt" name="Phone_Number" class="form-control" required="true" placeholder="Enter your Phone Number" maxlength="40" value="<?php echo $Phone_Number ?>" />
                </div> 
        </div>   
        ...
        <div class="form-group">
             ...
             <input type="text" style="font-size: 14pt" name="Email" class="form-control" required="true" placeholder="Enter your Email" maxlength="40" value="<?php echo $Email ?>" />
                </div>
        </div>
        
        <div class="form-group">
            <div class="input-group">
             <button type="submit" class="btn btn-lg btn-inf" name="btn-save-appointment">Schedule</button>
            </div>
            <br> </br>
        </div>
